        ...
        <form class="max-w-sm mx-auto mt-32" @submit.prevent>
            ...
            <div class="mb-5">
                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                    password</label>
                <div class="flex">
                    <input :type="passwordVisibility ? 'text' : 'password'" id="password" v-model="form.password"
                    ...
                    <button type="button" @click="passwordVisibility = !passwordVisibility"
                        ...
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" v-if="passwordVisibility"
                        ...
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" v-else
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
